export const loopMappings = [
  {
    ...
    internalPath: "request.requestType, request.serviceDate, request.procedureCodes, request.status",
    note: "Often anchors the service review event, including service type code and review dates. Usage can vary by implementation and companion guide.",
  },
  {
    loop: "2010EA",
  ...
  },
  {
    ...
    note: "Provider role, NPI, taxonomy, and facility-vs-rendering-provider requirements should be verified against payer companion guidance.",
  },
];
